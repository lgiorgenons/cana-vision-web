    ...
    <div className="min-h-screen bg-white font-sans text-slate-900 selection:bg-emerald-500/30">
      ...
      <section className="relative flex h-screen flex-col justify-center pb-24 pl-4 pr-4 md:pl-20">
        ...
        <div className="absolute inset-0 z-0">
          <img
            src="https://images.unsplash.com/photo-1560493676-04071c5f467b?q=80&w=3200&auto=format&fit=crop"
        ...
        <div className="relative z-10 max-w-full text-center px-4">
          ...
          <h1 className="text-5xl font-bold tracking-tight text-white drop-shadow-lg md:text-6xl lg:text-7xl leading-[1.1]">
            Monitoramento de <br />
            <span className="text-lime-400 drop-shadow-md">Cana-de-Açúcar</span> com <br />
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
            <Link to="/app">
              <Button size="lg" className="h-14 rounded-full bg-lime-400 px-10 text-lg font-bold text-slate-950 hover:bg-lime-500 transition-transform hover:scale-105">
        ...
        <div className="mx-auto max-w-7xl px-4">
          ...
          <div className="grid gap-8 md:grid-cols-2">
            ...
            <div className="group relative overflow-hidden rounded-[2.5rem] bg-white p-10 shadow-xl transition-all hover:-translate-y-1 hover:shadow-2xl">
              <div className="mb-8 inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-emerald-100 text-emerald-600">
            ...
            <div className="group relative overflow-hidden rounded-[2.5rem] bg-slate-900 p-10 shadow-xl transition-all hover:-translate-y-1 hover:shadow-2xl">
              <div className="mb-8 inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-emerald-500/20 text-emerald-400">
      ...
      <section className="bg-white py-24">
        <div className="mx-auto max-w-7xl px-4">
          <div className="mb-16 max-w-3xl">
            ...
            <div className="mt-8 flex items-center gap-2 text-emerald-600 font-medium cursor-pointer hover:underline">
              ...
              {accordionItems.map((item, i) => (
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <ChevronRight className={`h-5 w-5 transition-transform ${activeAccordion === i ? "rotate-90 text-emerald-600" : "text-slate-400"}`} />
                  </div>
      ...
      <section className="bg-slate-50 py-24">
        <div className="mx-auto max-w-7xl px-4">
          <div className="mb-12">
            <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-emerald-200 bg-emerald-100 px-3 py-1 text-sm font-medium text-emerald-700">
              <Leaf className="h-4 w-4" />
              Sustentabilidade
            </div>
            <h2 className="text-4xl font-bold tracking-tight text-slate-900 md:text-5xl">
          ...
          <div className="grid h-auto gap-6 md:grid-cols-4 md:grid-rows-2 lg:h-[600px]">
            ...
            <div className="relative flex flex-col justify-between overflow-hidden rounded-[2rem] bg-slate-950 p-8 text-white shadow-xl md:col-span-1 md:row-span-2">
              <div className="relative z-10">
                <div className="mb-6 flex h-12 w-12 items-center justify-center rounded-full bg-emerald-500 text-slate-950">
            ...
            <div className="flex flex-col justify-center rounded-[2rem] bg-emerald-50 p-8 shadow-xl md:col-span-1 md:row-span-1">
              <h3 className="text-lg font-bold text-emerald-900">Risco e Compliance</h3>
              ...
              <p className="mt-4 text-sm font-medium text-emerald-700">+45% Eficiência</p>
            </div>
            ...
            {[
              ...
              <div key={i} className="group cursor-pointer">
                ...
                <div className="flex items-center gap-3 text-sm text-slate-500">
                  <span className="font-semibold text-emerald-600">{news.tag}</span>
                  <span>•</span>
                  <span>{news.date}</span>
                </div>
                <h3 className="mt-2 text-xl font-bold text-slate-900 group-hover:text-emerald-600 transition-colors">
                  {news.title}
                </h3>
              </div>
            ))}
          ...
          <div className="grid gap-12 lg:grid-cols-4">
            <div className="lg:col-span-1">
              ...
              <div className="mt-6 flex gap-4">
                {/* Social Placeholders */}
                {[1, 2, 3, 4].map((i) => (
                  <div key={i} className="h-8 w-8 rounded-full bg-slate-800 hover:bg-emerald-500 transition-colors cursor-pointer" />
                ))}
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm">
                <li><a href="#" className="hover:text-emerald-400 transition-colors">CanaVision</a></li>
                <li><a href="#" className="hover:text-emerald-400 transition-colors">SojaVision</a></li>
                <li><a href="#" className="hover:text-emerald-400 transition-colors">BioClima</a></li>
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm">
                ...
                <li><a href="#" className="hover:text-emerald-400 transition-colors">Imprensa</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm">
                ...
                <li><a href="#" className="hover:text-emerald-400 transition-colors">Documentação API</a></li>
